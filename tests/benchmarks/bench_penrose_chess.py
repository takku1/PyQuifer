...
# ── PyQuifer imports (reorganized package hierarchy) ──
sys.path.insert(0, str(Path(__file__).resolve().parents[2] / "src"))
from pyquifer.dynamics.oscillators import LearnableKuramotoBank, PhaseTopologyCache
...
from pyquifer.identity.neural_darwinism import SelectionArena, HypothesisProfile
from pyquifer.dynamics.criticality.monitors import BranchingRatio
